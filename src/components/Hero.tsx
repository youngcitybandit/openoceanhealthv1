      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
            Together, we're building a smarter, more sustainable healthcare model—powered by innovation, designed for impact, and built to empower small to medium sized businesses employers, employees and healthcare providers, alike.
            <br /><br />
